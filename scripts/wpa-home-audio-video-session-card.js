...
(function () {
  ...
  function ensureStyles() {
    ...
    style.textContent = [
      ...
      '.wpa-home-av-badge{display:inline-flex;align-items:center;gap:6px;margin-bottom:12px;padding:5px 8px;border:1px solid rgba(201,168,76,.42);border-radius:999px;background:rgba(201,168,76,.09);color:#7a5d18;font:700 9.5px/1 var(--fb);letter-spacing:.7px;text-transform:uppercase;}',
      ...
      '.wpa-home-av-boundary{display:block;margin-top:8px;color:#7a5d18;font-size:11.5px;font-weight:700;}',
