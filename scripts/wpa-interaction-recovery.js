/* WPA interaction recovery, Journal Live entry points and corpus sync - 2026-07-23 */
(function () {
  'use strict';
  ...
  function boot() {
    ...
    addScript('wpa-corpus-sync-20260723-v4', '/scripts/wpa-corpus-sync-20260723.js?v=20260723-4');
  }
