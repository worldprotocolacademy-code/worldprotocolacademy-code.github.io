...
if (ap.get("total"),ap.get("monographs_and_handbooks"),ap.get("doctoral_dissertations"),ap.get("scientific_papers_and_contributions")) != (27,6,1,20): fail("Academic metrics must remain 27 = 6 + 1 + 20 unless canonically updated.")
