...
if public_now['de'].get('role')!='human_gated_public_pilot_candidate': fail('DE readiness role mismatch')
for code in ('fr','de'):
...
print('Global language governance OK: 50 canon; 4 public MK/EN/FR/DE; 46 fail-closed; 57 surfaces with exact four-language route parity.')
