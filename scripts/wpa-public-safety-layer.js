...
(function(){
  ...
  var replacements=[
    ['🛡️ Intelligence Center','📊 Analytical Center'],
    ['WPA Intelligence Center','WPA Analytical Center'],
    ['Intelligence Center','Analytical Center'],
    ['WPA Live Intelligence Feed','WPA Live Analytical Feed'],
    ['Live Intelligence Feed','Live Analytical Feed'],
    ['WPA Intelligence & Editorial Systems','WPA Analytical & Editorial Systems'],
    ['Academic Search, Live Intelligence and Journal Watch','Academic Search, Live Analysis and Journal Watch'],
    ['Premium WPA Briefings','Professional WPA Briefings · Future Programme'],
    ['Premium Briefings','Professional Briefings · Future Programme'],
    ['WPA Services Layer','WPA Professional Services · Development Preview'],
    ['Institutional Services','Professional Services · Development Preview'],
    ['Revenue слој','Future Sustainability Layer'],
    ['Побарај понуда','Изрази необврзувачки интерес'],
    ['Request Briefing','Express Professional Interest'],
    ['По договор','Достапноста не е активирана'],
    ['membership, partner benefits и одржлива growth логика','future community access, proposed partner framework and sustainable development logic'],
    ['институционална интелигенција','институционална аналитичка подготвеност'],
  ...
  function addBoundary(){
    ...
    box.innerHTML='<strong>WPA јавна граница · Public boundary:</strong> WPA е независна дигитална образовна, истражувачка и авторска платформа во развојна, тест и пробна фаза. Аналитичките модули користат јавни извори и немаат разузнавачка, надзорна, истражна или оперативна функција. Услуги, членства, сертификати, плаќања и комерцијални понуди не се активирани додека не се воспостави соодветна правна, етичка, даночна и платежна рамка.';
    var main=document.querySelector('main');
    if(main&&main.parentNode)main.parentNode.insertBefore(box,main);else document.body.insertBefore(box,document.body.firstChild);
  }
  ...
  function boot(){safeTextNodes(document.body);updateLinks();addBoundary();guardCommercialActions();}
