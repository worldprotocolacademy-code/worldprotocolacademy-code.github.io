 ...
 * v1.9: static dark-section markup in index.html replaces runtime tagging for robustness, with no dependency on JS timing or changeable data-i18n keys.
 */
(function(){
  'use strict';
