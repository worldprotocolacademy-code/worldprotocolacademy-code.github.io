...
if readiness.get('status','').startswith('candidate_pending'): err('readiness still claims SAFE-8Y Human Authority pending')
...
if errors:
    ...
    sys.exit(1)
verification=receipt.get('independent_custom_domain_http_verification')
print(f'SAFE-8Y German public-state OK: 57/57 routes; Human Authority receipt confirmed; merge and Pages success confirmed; public hub closure applied; independent custom-domain verification={verification}.')
