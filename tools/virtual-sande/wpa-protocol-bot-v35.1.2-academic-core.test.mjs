...
import { academicIntent, academicPayload, __academicTest } from './wpa-protocol-bot-v35.1.2-academic-router.mjs';
...
test('English shared-noun visit comparison',()=>assert.equal(academicIntent('Compare state, official and working visits','en')?.id,'visit_types'));
