...
for(const [name,obj] of Object.entries({dailyBrief,academicRadar:radar,editorialDossiers:dossiers,sourceAudit,diplomacyRadar:diplomacyProduct})){
...
const head=(title)=>`<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>${esc(title)} | World Protocol Academy</title><style>${css}</style></head><body><header><span class="tag">WPA AUTOMATED RESEARCH PRODUCTS · 24/7 PIPELINE</span><h1>${esc(title)}</h1><p>Generated ${esc(generated)} · Public-source and scholarly-metadata automation with explicit human-governance boundaries.</p><a class="btn secondary" href="/products/">Product Factory</a> <a class="btn secondary" href="/institute.html">WPA Institute</a></header><main>`;
...
let index=head('WPA 24/7 Product Factory')+`<section class="note guard"><strong>Production mode:</strong> the factory continuously converts monitored public sources and open scholarly metadata into finished, versioned WPA work products. Products are usable as research/editorial briefs in their stated status; scientific publication, official institutional claims and final judgments remain human-gated.</section><section class="grid">`;
